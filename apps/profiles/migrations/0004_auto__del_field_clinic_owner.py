...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Clinic.owner'
        db.delete_column('profiles_clinic', 'owner_id')


    def backwards(self, orm):
        
        # Adding field 'Clinic.owner'
        db.add_column('profiles_clinic', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['profiles.CompanyAdmin']), keep_default=False)
