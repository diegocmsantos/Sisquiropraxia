...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('profiles_address', 'state_id', 'state')
        # Changing field 'Address.state'
        db.alter_column('profiles_address', 'state', self.gf('django.db.models.fields.CharField')(max_length=2))

        # Removing index on 'Address', fields ['state']
        db.delete_index('profiles_address', ['state_id'])


    def backwards(self, orm):
        
        # Adding index on 'Address', fields ['state']
        db.create_index('profiles_address', ['state_id'])
        ...
        # Renaming column for 'Address.state' to match new field type.
        db.rename_column('profiles_address', 'state', 'state_id')
        # Changing field 'Address.state'
        db.alter_column('profiles_address', 'state_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.State']))
