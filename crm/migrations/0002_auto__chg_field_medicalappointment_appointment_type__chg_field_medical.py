...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MedicalAppointment.appointment_type'
        db.alter_column('crm_medicalappointment', 'appointment_type', self.gf('django.db.models.fields.CharField')(default=None, max_length=1))

        # Changing field 'MedicalAppointment.diagnostic'
        db.alter_column('crm_medicalappointment', 'diagnostic', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Changing field 'MedicalAppointment.appointment_type'
        db.alter_column('crm_medicalappointment', 'appointment_type', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))

        # Changing field 'MedicalAppointment.diagnostic'
        db.alter_column('crm_medicalappointment', 'diagnostic', self.gf('django.db.models.fields.CharField')(default=None, max_length=255))
